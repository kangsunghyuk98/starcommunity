...
<body>
    ...
    <div class="container">
        ...
        <div class="row Beverage_info  ">
            ...
            <div class="col-8 col-md-4 Beverage_img " style="float: left;">
                <img src="img/(1.6.1.1)스타벅스콜드브루.jpg" class="" alt="">
            </div>
            <div class="col-sm-4 col-md-8 Beverage_info_table " style="float: right;">
                ...
                <div>
                    <button type="button" onclick="location.href='./(1.6.1)BeverageList.html'"
        ...
        <div class="container-fluid mt-4 w3-border w3-round ws-grey clearfix" style="padding:20px 30px">
            <form action="" method="post">
                <div class="write_comment">
                    ...
                    <button type="button" href="#" class="btn btn-primary float-end btn-sm mb-4">코멘트 등록</button>
                </div>
            </form>
            <!-- 댓글 리스트 -->
            <div class="comment">
