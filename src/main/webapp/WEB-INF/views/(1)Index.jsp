    ...
    <div id="header">
        <div class="memberShip text-end">
            <sec:authorize access="isAnonymous()">
                <button type="button" class="login_btn btn "><a class="login_btn btn " href="/guest/login">Login</a></button>
            </sec:authorize>

            <sec:authorize access="isAuthenticated()">
            <sec:authentication property="principal.to.nickname" />님
            <button type="button" href="/guest/logout" class="signup_btn btn ">Log-out</button>
            </sec:authorize>
        </div>
