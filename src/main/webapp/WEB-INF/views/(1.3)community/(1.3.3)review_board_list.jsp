            ...
            <div class="col-md-3" style="float: none; margin: 0 auto;">
                <ul class="pagination justify-content-center">
                    ...
                    <c:if test="${pagination.curRange ne 1 }">
                        <li class="page-item"><a href="#" class="page-link btn_before" onClick="fn_paging('${category}', '${boardname}', 1)">처음</a></li>
                    </c:if>
      
                    <c:if test="${pagination.curPage ne 1}">
                        <li class="page-item"><a href="#" class="page-link btn_before" onClick="fn_paging('${category}', '${boardname}', '${pagination.prevPage }')">이전</a></li>
                    </c:if>
                    ...
                    <c:if test="${pagination.curPage ne pagination.pageCnt && pagination.pageCnt > 0}">
                        <li class="page-item"><a href="#" onClick="fn_paging('${category}', '${boardname}', '${pagination.nextPage }')" class="page-link btn_next">다음</a></li>
                    </c:if>

                    <c:if test="${pagination.curRange ne pagination.rangeCnt && pagination.rangeCnt > 0}">
                        <li class="page-item"><a href="#" onClick="fn_paging('${category}', '${boardname}', '${pagination.pageCnt }')" class="page-link btn_next">끝</a></li>
                    </c:if>
                </ul>
            </div>
        </div>
