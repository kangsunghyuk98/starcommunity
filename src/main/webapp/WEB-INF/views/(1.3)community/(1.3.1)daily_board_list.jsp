	    			...
	    			$.ajax({
	    				...
	    				success: function(jsonData){
	    					...
	    					if( pagination.curRange != pagination.rangeCnt && pagination.rangeCnt > 0 ) {
	    						htmlPg += '<li class="page-item"><button class="page-link ajaxCall btn_next" url="/searchBoardList?boardname='+boardname+'&currentPage='+pagination.pageCnt+'&searchReq='+searchReq+'&searchOption='+searchOption+'">끝</li>';
	    					}
            ...
            <div class="col-md-3" style="float: none; margin: 0 auto;">
                <ul class="pagination justify-content-center">
                    ...
                    <c:if test="${pagination.curRange ne 1 }">
                        <li class="page-item btn_before"><button class="page-link btn_before" onClick="fn_paging('${category}', '${boardname}', 1)">처음</li>
                    </c:if>
      
                    <c:if test="${pagination.curPage ne 1}">
                        <li class="page-item btn_before"><button class="page-link btn_before" onClick="fn_paging('${category}', '${boardname}', '${pagination.prevPage }')">이전</li>
                    </c:if>
                    ...
                    <c:if test="${pagination.curPage ne pagination.pageCnt && pagination.pageCnt > 0}">
                        <li class="page-item "><button onClick="fn_paging('${category}', '${boardname}', '${pagination.nextPage }')" class="page-link btn_next">다음</li>
                    </c:if>

                    <c:if test="${pagination.curRange ne pagination.rangeCnt && pagination.rangeCnt > 0}">
                        <li class="page-item "><button onClick="fn_paging('${category}', '${boardname}', '${pagination.pageCnt }')" class="page-link btn_next">끝</li>
                    </c:if>
                </ul>
            </div>
        </div>
